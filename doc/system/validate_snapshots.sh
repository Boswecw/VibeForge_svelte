...
ASSEMBLED_OUTPUT="${1:-$ROOT_DIR/doc/VBFSYSTEM.md}"
...
require_contains "$PARTS_DIR/_index.md" "Primary output: \`doc/VBFSYSTEM.md\`" "index primary output"
...
require_contains "$ASSEMBLED_OUTPUT" "Primary output: \`doc/VBFSYSTEM.md\`" "assembled primary output"
